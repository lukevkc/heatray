<template>
  <div class="app">
    <div class="content-back bg-gradient-to-b from-sky-950 from-20% via-sky-800 via-85% to-white to-85%">
    </div>
...
<script lang="ts">
  ...
  const FooterLight = defineAsyncComponent(() => import("../components/FooterLight.vue"));
