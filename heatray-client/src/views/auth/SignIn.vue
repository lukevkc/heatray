	...
	<div class="flex justify-center items-center">
		<div
			...
			<div class="flex justify-center items-center flex-col">
				...
				<h1 class="text-xl font-semibold">Sign in into heatray</h1>
			</div>
			<form class="mt-6">
				<div>
			...
			<div class="mt-4 text-center">
				<a href="#"
					class="text-blue-500 transition-all duration-300 hover:text-gray-800 text-xs hover:underline">Not
					have account yet? Register</a>
			</div>
		</div>
	</div>
</template>
